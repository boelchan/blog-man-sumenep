        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <x-form :action="route('post.profil.update', [$profil->id, 'uuid' => $profil->uuid])" method="PATCH" enctype="multipart/form-data">
                            <div class="row">
                                @bind($profil)
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            <label for="">Gambar</label>
                                            <img id="output" src="{{ $profil->gambar ? asset('storage/profil/' . $profil->gambar) : '' }}" class="img-fluid rounded">
                                        ...
                                        <x-form-textarea name="nama" label="Nama Profil" class="mb-2 h-auto" rows="3" />
