        ...
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <x-form :action="route('post.banner.update', [$banner->id, 'uuid' => $banner->uuid])" method="PATCH" enctype="multipart/form-data">
                            <div class="row">
                                @bind($banner)
                                    <div class="col-md-12">
                                        <div class="form-group mb-2">
                                            <label for="">Gambar</label>
                                            <img id="output" src="{{ $banner->gambar ? asset('storage/gambar/' . $banner->gambar) : '' }}" class="img-fluid rounded">
                                        ...
                                        <div x-data="{ open: {{ $banner->publish == 'ya' ? 'true' : 'false' }} }" class=" bg-secondary-lt p-3 mb-2">
                                            <x-form-group name="publish" label="Terbitkan banner" inline class="mb-2">
