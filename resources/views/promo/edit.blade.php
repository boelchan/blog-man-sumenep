        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <x-form :action="route('post.promo.update', [$promo->id, 'uuid' => $promo->uuid])" method="PATCH" enctype="multipart/form-data">
                            <div class="row">
                                @bind($promo)
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            <label for="">Gambar</label>
                                            <img id="output" src="{{ $promo->gambar ? asset('storage/gambar/' . $promo->gambar) : '' }}" class="img-fluid rounded">
                                        ...
                                        <div x-data="{ open: {{ $promo->publish == 'ya' ? 'true' : 'false' }} }" class=" bg-secondary-lt p-3 mb-2">
                                            <x-form-group name="publish" label="Terbitkan promo" inline class="mb-2">
