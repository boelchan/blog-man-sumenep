        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <x-form :action="route('post.poli.update', [$poli->id, 'uuid' => $poli->uuid])" method="PATCH" enctype="multipart/form-data">
                            <div class="row">
                                @bind($poli)
                                    <div class="col-md-4">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <img id="output" src="{{ $poli->icon ? asset('storage/poly/icon/' . $poli->icon) : '' }}" class="img-fluid rounded">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <img id="output" src="{{ $poli->gambar ? asset('storage/poly/' . $poli->gambar) : '' }}" class="img-fluid rounded">
                                        ...
                                        <x-form-textarea name="nama" label="Nama poli" class="mb-2 h-auto" rows="3" />
