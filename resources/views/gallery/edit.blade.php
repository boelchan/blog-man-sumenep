        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <x-form :action="route('post.gallery.update', [$gallery->id, 'uuid' => $gallery->uuid])" method="PATCH" enctype="multipart/form-data">
                            <div class="row">
                                @bind($gallery)
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            <label for="">Gambar</label>
                                            <img id="output" src="{{ $gallery->gambar ? asset('storage/gambar/' . $gallery->gambar) : '' }}" class="img-fluid rounded">
                                        ...
                                        <div x-data="{ open: {{ $gallery->publish == 'ya' ? 'true' : 'false' }} }" class=" bg-secondary-lt p-3 mb-2">
                                            <x-form-group name="publish" label="Terbitkan gallery" inline class="mb-2">
