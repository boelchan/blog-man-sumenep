        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <x-form :action="route('post.agenda.update', [$agenda->id, 'uuid' => $agenda->uuid])" method="PATCH" enctype="multipart/form-data">
                            <div class="row">
                                @bind($agenda)
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            <label for="">Gambar</label>
                                            <img id="output" src="{{ $agenda->gambar ? asset('storage/gambar/' . $agenda->gambar) : '' }}" class="img-fluid rounded">
                                        ...
                                        <div x-data="{ open: {{ $agenda->publish == 'ya' ? 'true' : 'false' }} }" class=" bg-secondary-lt p-3 mb-2">
